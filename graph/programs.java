...
The Amazon Fres team is planning a route for a delivery truck to deliver customer orders in the city of Techland. The planner will create a delivery area for 
each order to effectively plan the route. The area is abstracted as a grid.
...
The input to the function/method consists of three arguments numRows, an integer representing the number of rows, numColumns,
an integer representing the number of columns, area, representing the two-dimensional grid of integers.
